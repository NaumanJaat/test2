...
// //Base 10/ 0 - 9. 1/10 = 0.1 3/10 = 0.3
// //Binary 2/ 0 1 console.log(Number,parseInt('30px', 10));
...
// //chwck if value is NAN
// console.log(Number.isNaN(20))
// console.log(Number.isNaN('20'))
// console.log(Number.isNaN(+'20x'))
// console.log(Number.isNaN(20 / 0))

// //chwck if value is finite
...
// console.log(Math.max(5,11,23,2,18))
// console.log(Math.max(5,11,'23',2,18))
// console.log(Math.max(5,11,'23px',2,18))

// console.log(Math.min(5,11,23,2,18));
...
// //Rounding Decimal
// console.log((2.7).toFixed(0)) //tofixed always return string
...
//  const PI = 3.1415;//3._1415 not allowed
//  console.log(PI)

//  console.log(Number('230_000')) not allowed.
...
// console.log(new Date(2037, 10, 19, 15, 30, 12))// month base is 0;
...
// const days1 = CalDayPassed(new Date(2037, 3, 14), new Date(2037, 3, 24));
// console.log(days1);
